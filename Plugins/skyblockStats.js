...
async function createStatsInventory(player) {
	...
	function parseProfileItems() {
		switch (profileItems.length) {
			...
			case 6:
				Logger.warn(`SkyblockStats | parseProfileItems() ERROR | Inputted Data:\n\n${JSON.stringify(profileItems)}\n\nWith Length: 6`);
				return [
					{ item: profileItems[0], position: 10 },
					{ item: profileItems[1], position: 11 },
					{ item: profileItems[2], position: 12 },
					{ item: profileItems[3], position: 14 },
					{ item: profileItems[4], position: 15 },
					{ item: profileItems[5], position: 16 }
				];
			case 7:
				Logger.warn(`SkyblockStats | parseProfileItems() ERROR | Inputted Data:\n\n${JSON.stringify(profileItems)}\n\nWith Length: 7`);
				return [
					...
					{ item: profileItems[1], position: 11 },
					{ item: profileItems[2], position: 12 },
					{ item: profileItems[3], position: 13 },
					{ item: profileItems[4], position: 14 },
					{ item: profileItems[5], position: 15 },
					{ item: profileItems[6], position: 16 }
				];
			case 8:
				Logger.warn(`SkyblockStats | parseProfileItems() ERROR | Inputted Data:\n\n${JSON.stringify(profileItems)}\n\nWith Length: 8`);
				return [
					{ item: profileItems[0], position: 9 },
					{ item: profileItems[1], position: 10 },
					{ item: profileItems[2], position: 11 },
					{ item: profileItems[3], position: 12 },
					{ item: profileItems[4], position: 14 },
					{ item: profileItems[5], position: 15 },
					{ item: profileItems[6], position: 16 },
					{ item: profileItems[7], position: 17 }
				];
			case 9:
				Logger.warn(`SkyblockStats | parseProfileItems() ERROR | Inputted Data:\n\n${JSON.stringify(profileItems)}\n\nWith Length: 9`);
				return [
					...
					{ item: profileItems[2], position: 11 },
					{ item: profileItems[3], position: 12 },
					{ item: profileItems[4], position: 13 },
					{ item: profileItems[5], position: 14 },
					{ item: profileItems[6], position: 15 },
					{ item: profileItems[7], position: 16 },
					{ item: profileItems[8], position: 17 }
				];
			default:
				Logger.error(`parseProfileItems() ERROR | HANDLED BY DEFAULT | Inputted Data:\n\n${JSON.stringify(profileItems)}\n\nWith Length: ${profileItems.length}`);
				return [
					{ item: profileItems[0], position: 9 },
					{ item: profileItems[1], position: 10 },
					{ item: profileItems[2], position: 11 },
